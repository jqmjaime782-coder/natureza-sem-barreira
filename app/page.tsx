        ...
        <div className="space-y-4">
          <Link href="/ficha-a" className="block bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl" style={{ background: "#D6EAD8" }}>🏕️</div>
              <div>
          ...
          <Link href="/ficha-b" className="block bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl" style={{ background: "#D6EAD8" }}>👥</div>
              <div>
          ...
          <Link href="/ficha-c" className="block bg-white rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl" style={{ background: "#D6EAD8" }}>🎤</div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gray-400">Ficha C</p>
                <h2 className="text-lg font-bold text-gray-800">Entrevista Individual</h2>
                <p className="text-sm text-gray-500">Entrevista aprofundada com uma PcD da comunidade</p>
              </div>
            </div>
          </Link>
